...
$(document).ready(function () {
  ...
  var discussionInput = "";
  // $(".form-controldropdown").on("change", function(){
  //   discussionInput = $(".form-controldropdown").val();
  // })
  var newPostYes = "No";
  var firstTime = "Yes";
  var editPost = "No";
  ...
  var discussionInput = $("#discussion");
  ...
  $(blogForm).on("submit", function handleFormSubmit(event) {
      ...
      var discussionThread = $("#discussion :selected").text();
      console.log("Discussion Input=" + discussionThread);
      var blogEmail = localStorage.getItem("CometSession");
      console.log("BlogEmail=" + blogEmail);
      blogemail = blogEmail;
  ...
  $('#logout').on("click", function () {
      event.preventDefault();
      //socket.disconnect();
      var useremail = localStorage.getItem("CometSession");
